-- ============================================
-- COMPLETE DATABASE SETUP FOR LEETCODE TRACKER
...
DROP POLICY IF EXISTS "Allow all on bookmarks" ON bookmarks;
DROP POLICY IF EXISTS "Allow all on bookmark_items" ON bookmark_items;
DROP POLICY IF EXISTS "Allow all on problem_notes" ON problem_notes;
DROP POLICY IF EXISTS "Allow all on code_snippets" ON code_snippets;
DROP POLICY IF EXISTS "Allow all on custom_problems" ON custom_problems;
...
DROP TRIGGER IF EXISTS update_problem_notes_updated_at ON problem_notes;
DROP TRIGGER IF EXISTS update_code_snippets_updated_at ON code_snippets;
DROP TRIGGER IF EXISTS update_custom_problems_updated_at ON custom_problems;
...
AND table_name IN (
  'users', 'companies', 'user_progress', 'bookmarks', 
  'bookmark_items', 'problem_notes', 'code_snippets', 'custom_problems'
)
ORDER BY table_name;
